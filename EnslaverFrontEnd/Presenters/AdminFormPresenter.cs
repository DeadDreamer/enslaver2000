...
namespace EnslaverFrontEnd.Presenters
{
    public class AdminFormPresenter : BasePresenter
    {
        ...
        public CascadeClassifier face = new CascadeClassifier("haarcascade_frontalface_default.xml");
        public CascadeClassifier eyes = new CascadeClassifier("haarcascade_eye.xml");
        public CascadeClassifier smile = new CascadeClassifier("haarcascade_smile.xml");
